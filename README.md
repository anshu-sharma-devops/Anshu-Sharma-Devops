...
[![Typing SVG](https://readme-typing-svg.herokuapp.com?font=Fira+Code&size=22&pause=1000&color=F7971E&center=true&vCenter=true&width=700&lines=Cloud+%26+DevOps+Engineer+in+Progress+%F0%9F%9B%A0%EF%B8%8F;Linux+%7C+AWS+%7C+Docker+%7C+Terraform+%7C+Jenkins;Automating+Infrastructure%2C+One+Script+at+a+Time+%F0%9F%90%8D;From+Commerce+to+Cloud+%E2%80%94+Building+the+Future+%F0%9F%9A%80)](https://github.com/anshu-sharma-devops)
...
Status     : Actively building portfolio & seeking opportunities
```
...
<img src="https://raw.githubusercontent.com/anshu-sharma-devops/anshu-sharma-devops/main/github-metrics.svg" width="95%" />
...
> ⚙️ **Analytics card:** generated by a GitHub Action (`metrics.yml`) that commits `github-metrics.svg` straight to `main` on a daily schedule, instead of depending on the (currently unreliable) public Vercel API.
...
![Wave](https://capsule-render.vercel.app/api?type=waving&color=F7971E&height=100&section=footer)
