...
<img src="https://raw.githubusercontent.com/anshu-sharma-devops/anshu-sharma-devops/output/github-metrics.svg" width="95%" />
...
> ⚙️ **Analytics card:** generated by a GitHub Action (`metrics.yml`) that commits `github-metrics.svg` to the `output` branch daily, instead of depending on the (currently unreliable) public Vercel API.
